...
Notably, proCoV2 turns out to be identical to one of the putative progenitors yielded by my approach in Figure~\ref{fig:tree_RaTG13} of simply placing the root at the three possible locations closest to the bat outgroup.
...
Before moving onto the next section, I will also briefly address several less plausible explanations for the discordance that have gained traction in popular discussion of SARS-CoV-2's origins.
The first explanation suggests that the RaTG13 sequence might be faked in a way that confounds phylogenetic inference of SARS-CoV-2's progenitor.
This explanation can be discounted, because although there are some unusual aspects of RaTG13's primary sequencing data~\citep{singla2020novo,rahalkar2020anomalous}, the fundamental conundrum about the progenitor described above holds for other outgroups such as RpYN06, RmYN02, and more distant bat coronaviruses reported before the emergence of SARS-CoV-2 such as ZC45~\citep{tang2020origin}.
