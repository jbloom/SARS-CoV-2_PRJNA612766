...
Phylogenetic analysis of these sequences in the context of carefully annotated existing data supports existing data indicating that the Huanan Seafood Market sequences that are the focus of the joint WHO-China report are not fully representative of the viruses in Wuhan early in the epidemic.
...
\begin{figure}
\centerline{\fbox{\includegraphics[width=0.95\linewidth]{figures/SRA_email.png}}}
