...
It therefore seems likely the sequences were deleted from the SRA to obscure their existence.
...
Certainly further application of more advanced methods would be a welcome advance.
...
Finally, both plausible putative progenitors described above require that one of the earliest mutations to SARS-CoV-2 was a reversion towards the bat coronavirus outgroups (either C18060T or C29095T) on a branch that subsequently gave rise to multiple distinct descendants.
Such a non-parsimonious scenario can only be avoided by invoking recombination very early in the pandemic, which is not entirely implausible for a coronavirus~\citep{boni2020evolutionary}.
However, because the outgroups have $\sim$4\% nucleotide divergence from SARS-CoV-2, a mutation towards the outgroup is also in the realm of reasonable possibility.
...
More broadly, ..., implications for further study. getting info from NIH on these and others.
