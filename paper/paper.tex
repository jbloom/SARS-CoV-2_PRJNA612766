...
However, the sophisticated algorithm of \citet{kumar2021evolutionary} and my more simplistic approach both ignore sampling dates, which is probably a major reason that they both infer a progenitor that is three mutations away from the earliest sequences reported from Wuhan.
