...
The plot in Figure~\ref{fig:deltadist_RaTG13} contains all of the GISAID sequences after this filtering, and was rendered using \texttt{Altair}~\citep{vanderplas2018altair}.
