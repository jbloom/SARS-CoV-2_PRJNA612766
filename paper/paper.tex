...
I recover the deleted files from the Google Cloud, and use them to reconstruct partial sequences of 13 early epidemic viruses.
Phylogenetic analysis of these sequences in the context of carefully annotated existing data suggest that the Huanan Seafood Market sequences that are the focus of the joint WHO-China report are not fully representative of the viruses in Wuhan early in the epidemic.
